...
console.log("======================");
console.log("");
console.log("The XREAL SDK requires manual download from https://developer.xreal.com/");
console.log("");
console.log("Steps:");
...
console.log("5. Replace Camera2Service with NRCameraRig (see XrealBridgeJs.kt)");
console.log("6. Build: ./gradlew assembleDebug");
console.log("");
console.log("XREAL One Pro / Air 3 require SDK 3.0.0+ for spatial computing features.");
console.log("XReal Air 2 Ultra can use SDK 2.x for basic WebView support.");

if (existsSync(libsDir)) {
  const hasAar = ["nrsdk3.aar", "xreal-sdk.aar", "nrsdk.aar"].some(
    (f) => existsSync(resolve(libsDir, f))
  );
  if (hasAar) {
