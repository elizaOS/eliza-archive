...
Sequential training on 4 task(s) sharing one observation/action space, 2500 env-steps/task, 1 seed(s). After every phase both learners are evaluated on **all** tasks; metrics are computed from the resulting task×phase matrix (Lopez-Paz & Ranzato 2017).

Learners: `alberta, ppo`.

| metric | Alberta | PPO | better |
|--------|---------|-----|--------|
| ACC ↑ | 3.91 ± 0.00 | 2.71 ± 0.00 | **Alberta** |
| BWT ↑ (0 = no forgetting) | 0.00 ± 0.00 | 0.56 ± 0.00 | **PPO** |
| FORGETTING ↓ | 0.00 ± 0.00 | 0.03 ± 0.00 | **Alberta** |
| FWT ↑ | 0.00 ± 0.00 | 0.57 ± 0.00 | **PPO** |
...
|---|---:|---:|---:|---:|
| `alberta` | 3.51 | 3.0/4.0 | 0.00 | -0.13 |
| `ppo` | 1.88 | 4.0/4.0 | 1.79 | -0.03 |
